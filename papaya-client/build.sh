...
JAVA_VERSION=17
MAIN_JAR="papaya-client-$PROJECT_VERSION.jar"
...
detected_modules=`jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/dev/tronxi/papayaclient/PapayaClientApplication.class`
...
manual_modules=,jdk.crypto.ec,jdk.localedata,java.desktop
